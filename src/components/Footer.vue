  ...
  <div id="footer">
    ...
    <b-row>
      <b-col>
        ...
        <router-link to="/term">นโนบายและเงื่อนไขการใช้งาน</router-link><p/>
        <router-link to="/how_to_delete">ขั้นตอนการลบบัญชี</router-link><p/>
      </b-col>
      <b-col>
        <b>ช่องทางการติดต่อ</b><p/>
        <p>email : <a :href="'mailto:' + email_url">{{ email_url }}</a></p>
