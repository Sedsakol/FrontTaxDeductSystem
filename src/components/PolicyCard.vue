<template>
  <div id="card">
    <div class="card">
      <div class="card-body">
        <h4 class="text-center card-title">Privacy Policy</h4>
          ...
          <li>
          <p><strong>Website</strong> refers to Tax Deduct, accessible from <a href="https://taxdeduct-2bd59.web.app/" rel="external nofollow noopener" target="_blank">
          ...
          <li>By visiting this page on our website: 
              <a href="https://taxdeduct-2bd59.web.app/" rel="external nofollow noopener" target="_blank">
                https://taxdeduct-2bd59.web.app/
              </a>
          </li>
          </ul>
